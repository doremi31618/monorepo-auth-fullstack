...
describe('AuthService', () => {
  ...
  describe('login', () => {
    ...
    it('returns user identity when credentials are valid', async () => {
      ...
      expect(userRepository.getUserByEmail).toHaveBeenCalledWith(loginDto.email);
    ...
    it('throws when the user does not exist', async () => {
      ...
      await expect(service.login(loginDto)).rejects.toThrow(new BadRequestException('Invalid credentials'));
  ...
  describe('signup', () => {
    ...
    it('hashes the password, creates the user, and returns identity', async () => {
      ...
      expect(userRepository.getUserByEmail).toHaveBeenCalledWith(signupDto.email);
    ...
    it('throws when the email is already registered', async () => {
      ...
      await expect(service.signup(signupDto)).rejects.toThrow(new BadRequestException('User already exists'));
